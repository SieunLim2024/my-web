...
<body bgcolor="<%=bodyback_c%>">
	<center>
		...
		<table border="1" width="700" cellpadding="0" cellspacing="0"
			...
			for (int i = 0; i < articleList.size(); i++) {
				FreeBoardVO article = (FreeBoardVO) articleList.get(i);
			%>
			<tr height="30">
 ...
 %>
		...
		%>
		<a href="freeBoardList.jsp?pageNum=<%=startPage - pageBlock%>">[이전]</a>
		...
		if (endPage < pageCount) {
		%>
		<a href="freeBoardList.jsp?pageNum=<%=startPage + pageBlock%>">[다음]</a>
		<%
		}
		}
		%>
