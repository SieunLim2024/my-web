...
try{
	...
	FreeBoardVO article = dbPro.updateGetArticle(num);
%>
...
<script language="JavaScript" src="./js/boardScript.js"></script>
</head>
...
'freeBoardList.jsp?pageNum=<%=pageNum%>'">
